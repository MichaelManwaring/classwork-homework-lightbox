...
// Declare a function that, accepts user input (from an input element). Also create a variable in JS assigned to a word of your choice. Depending upon the length of the text the user types, tell the user how many characters off their text was from your "secret" word. 
